...
Public Class VentanaPedido
    ...
    Private Sub dataproductospedido_CellContentClick(sender As System.Object, e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dataproductospedido.CellContentClick
        btnagregarproductopedido.Enabled = True
    End Sub
    ...
    Private Sub LlenarCombo()
        ...
        If datapedido.SelectedCells.Item(7).Value.Equals("CONFIRMADO") Or datapedido.SelectedCells.Item(7).Value.Equals("RECHAZADO ") Then
