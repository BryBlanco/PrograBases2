...
Public Class VentanaCatalogo
    ...
    Private Sub InsertarCatalogo()
        Dim CodCatalogo As String = txtidcatalogo.Text
        ...
        comando.Parameters.AddWithValue("@costo_unitario", CostoUnitarioCatalogo)
        comando.Parameters.AddWithValue("@precio_venta", PrecioVentaCatalogo)
        comando.Parameters.AddWithValue("@existencias", ExistenciasCatalogo)
        comando.Parameters.AddWithValue("@impuesto_venta", ImpuestoCatalogo)
        adaptador = New SqlDataAdapter(comando)
        tabla = New DataTable
        adaptador.Fill(tabla)
        DataCatalogo.DataSource = tabla
    ...
    Private Sub mostrareditarcatalogo()
        txtidcatalogo.Text = DataCatalogo.SelectedCells.Item(0).Value
